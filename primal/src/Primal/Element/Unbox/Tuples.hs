...
instance (Unbox a, Unbox b, Unbox c) => Unbox (a, b, c) where
  ...
  readByteOffMutableByteArray# mba# i0# s =
    let i1# = i0# +# sizeOf# (proxy# :: Proxy# a)
     ...
     in case readByteOffMutableByteArray# mba# i0# s of
          (# s0, a0 #) ->
            case readByteOffMutableByteArray# mba# i1# s0 of
              (# s1, a1 #) ->
                case readByteOffMutableByteArray# mba# i2# s1 of
                  (# s2, a2 #) ->
                    (# s2, (a0, a1, a2) #)
  {-# INLINE readByteOffMutableByteArray# #-}
  readOffAddr# addr# i# s =
    let addr0# = addr# `plusAddr#` (i# *# sizeOf# (proxy# :: Proxy# (a, b, c)))
     ...
     in case readOffAddr# addr0# 0# s of
          (# s0, a0 #) ->
            case readOffAddr# addr1# 0# s0 of
              (# s1, a1 #) ->
                case readOffAddr# addr2# 0# s1 of
                  (# s2, a2 #) ->
                    (# s2, (a0, a1, a2) #)
  {-# INLINE readOffAddr# #-}
...
instance
  (Unbox a, Unbox b, Unbox c, Unbox d, Unbox e, Unbox f, Unbox g, Unbox h)
  => Unbox (a, b, c, d, e, f, g, h)
  where
...
instance
  (Unbox a, Unbox b, Unbox c, Unbox d, Unbox e, Unbox f, Unbox g, Unbox h, Unbox i)
  => Unbox (a, b, c, d, e, f, g, h, i)
  where
