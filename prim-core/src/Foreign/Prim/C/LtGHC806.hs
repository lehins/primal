...
foreign import ccall unsafe "prim_core_compat.c prim_core_memread32"
...
foreign import ccall unsafe "prim_core_compat.c prim_core_memwrite32"
...
foreign import ccall unsafe "prim_core_compat.c prim_core_memread64"
  indexWord8ArrayAsAddr# :: ByteArray# -> Int# -> Addr#

foreign import ccall unsafe "prim_core_compat.c prim_core_memread64"
  readWord8ArrayAsPtrIO# :: MutableByteArray# d -> Int# -> IO (Ptr a)

foreign import ccall unsafe "prim_core_compat.c prim_core_memwrite64"
...
foreign import ccall unsafe "prim_core_compat.c prim_core_memread16"
...
foreign import ccall unsafe "prim_core_compat.c prim_core_memwrite16"
