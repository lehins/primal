...
forAllMutRef ::
     forall mr e a. (Show e, Testable a, Elt mr e, MutRef mr)
  => Gen e
  -> (e -> mr e RW -> IO a)
  -> Property
...
prop_newReadMutRef ::
     forall mr e. (Eq e, Show e, Elt mr e, MutRef mr)
  => e
  -> Property
...
asyncProp ::
     forall mr e a. (Show e, Arbitrary e, AtomicElt mr e, Elt mr e, AtomicMutRef mr)
  => ((e, [e]) ->
      (e, [e]) ->
      (e, [a]) ->
      (e, [a]) ->
